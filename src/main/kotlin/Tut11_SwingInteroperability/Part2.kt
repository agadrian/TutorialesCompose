package Tut11_SwingInteroperability
            ...
            SwingPanel(
                ...
                factory = {
                    JPanel().apply {
                        ...
                        add(actionButtons("1. Swing Button: decrement", dec))
                        add(actionButtons("2. Swing Button: decrement", dec))
                        add(actionButtons("3. Swing Button: decrement", dec))
                    }
                }
            )
